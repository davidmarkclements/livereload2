  ...
  Parser.prototype.process = function(data) {
    ...
    try {
      if (!(this.protocol != null)) {
        ...
        message = this._parseMessage(data, ['load', 'reload', 'alert']);
...
__livereload.LiveReload = LiveReload = (function() {
    ...
    this.connector = new Connector(this.options, this.WebSocket, Timer, {
      ...
      message: function(message) {
        switch (message.command) {
          ...
          case 'load':
            return _this.performLoad(message);
        }
      }
    });
  }
  ...
  LiveReload.prototype.performLoad = function(message) {
    var _ref, _ref2;  
    if (this.key !== message.key) {return;}    
